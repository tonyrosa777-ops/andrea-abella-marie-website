          ...
          >
            ...
            <div className="flex items-center justify-between px-6 py-5 border-b border-white/10">
              <div>
                ...
                {count > 0 && (
                  <p className="text-gold/70 text-xs mt-0.5" style={{ fontFamily: "var(--font-ui)" }}>
            ...
            <div className="flex-1 overflow-y-auto px-6 py-4 space-y-4">
              {items.length === 0 ? (
                <div className="flex flex-col items-center justify-center h-full text-center">
                  ...
                  <p className="text-white/40 text-sm" style={{ fontFamily: "var(--font-ui)" }}>
                    Your cart is empty
                  </p>
                  <button
                    onClick={closeCart}
                    className="mt-4 text-gold text-sm underline underline-offset-2 hover:text-gold-light transition-colors"
                ...
                items.map((item) => (
                  ...
                  >
                    ...
                    <div className="flex-1 min-w-0">
                      ...
                      <p className="text-gold text-sm mt-1" style={{ fontFamily: "var(--font-display)", fontWeight: 700 }}>
                    ...
                    <div className="flex flex-col items-end justify-between shrink-0">
                      ...
                      <div className="flex items-center gap-2 bg-white/10 rounded-full px-2 py-1">
                        ...
                        <span className="text-white text-xs w-4 text-center" style={{ fontFamily: "var(--font-ui)" }}>
                          {item.quantity}
                        </span>
                        <button
                          onClick={() => updateQuantity(item.id, item.quantity + 1)}
            ...
            {items.length > 0 && (
              <div className="px-6 py-5 border-t border-white/10 space-y-4">
                <div className="flex items-center justify-between">
                  <span className="text-white/60 text-sm" style={{ fontFamily: "var(--font-ui)" }}>
                    Subtotal
                  </span>
                  <span
